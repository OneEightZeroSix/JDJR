                ...
                <div className="wx_wrap" id="wrapBody">
                    ...
                    <div id="pagePay">
                        ...
                        <div id="venderOrderList">
                            ...
                            <div className="buy_checkout" id="buyDiscountArea">
                                <ul>
                                    ...
                                    <li id="conponListTab" >
                                        <a id="jdQuanTab" className="content">
                                            <strong>京东券</strong>
                                            <span style={{display:"inlineBlock",border:"1px solid #e93b3d",marginRight:"5px",color:"#e93b3d",fontSize:"10px",height:"12px",lineHeight:"12px"}}>有1张可用</span>
                        ...
                        <div id="payArea" className="pay_area">
                            <p className="price">总价：<strong id="pageTotalPrice" price="6999.00">¥6999.00</strong> </p> <a className="order_additional_tips type_lnk"
