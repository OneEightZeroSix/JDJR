...
class Login extends Component {
    ...
    updata(){
        ...
        $.ajax({
            ...
            url: "http://localhost:3001/login/updata",
            async: false,
        ...
        return (
            <div >
                ...
                <div style={{width:"100%",padding:"10px 0"}}>
                    <div style={{height:"30px",lineHeight:"30px",marginLeft:"20px",fontSize:"12px"}}>设置新的登入密码</div>
                    <input onChange={this.pass.bind(this)} type="text" placeholder="6-20位数字／字母／字符组合" style={{height:"40px",lineHeight:"40px",paddingLeft:"5%",background:"#fff",width:"90%",margin:"0 5%",fontSize:"12px",marginBottom:"20px"}}></input>
