        ...
        <section className="container mainIn">
          ...
          <section id="hasCarAndMoney" className="bannerAndCarContainer">
            ...
            <section id="bannerCont" className="swiper-container bannerContainer bannerLoginStatus swiper-container-horizontal">
              <div className="swiper-wrapper" style={{transform:"translate3d(-640px, 0px, 0px)",transitionDuration:"3000ms"}}>
                  <div className="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-active"  style={{width:"320px"}}><img src="https://img12.360buyimg.com/jrpmobile/jfs/t30277/153/410933370/62629/1bde9d7f/5bf2678fN9ace94da.png?width=1080&amp;height=240"  className="imgPic" /></div>
                  <div className="swiper-slide swiper-slide-prev swiper-slide-duplicate-next" style={{width:"320px"}}><img src="https://img12.360buyimg.com/jrpmobile/jfs/t30595/13/280997098/57324/f8c24347/5bee212dN45cd3aec.png?width=1080&amp;height=240"  className="imgPic" /></div>
                  <div className="swiper-slide swiper-slide-active"  style={{width:"320px"}}><img src="https://img12.360buyimg.com/jrpmobile/jfs/t30277/153/410933370/62629/1bde9d7f/5bf2678fN9ace94da.png?width=1080&amp;height=240"  className="imgPic" /></div>
                  <div className="swiper-slide swiper-slide-duplicate swiper-slide-next swiper-slide-duplicate-prev" style={{width:"320px"}}><img src="https://img12.360buyimg.com/jrpmobile/jfs/t30595/13/280997098/57324/f8c24347/5bee212dN45cd3aec.png?width=1080&amp;height=240"  className="imgPic" /></div>
              </div>
              <div id="bannerContCircle" className="swiper-pagination swiper-pagination-bullets">
